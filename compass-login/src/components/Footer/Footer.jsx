  ...
  return (
    <footer>
      ...
      <div className="buttonsContainer">
        <Button id="navegate" name="navegate" onClick={() => {seconds=600}} text="Continuar Navegando" />
        <Button id="logout" name="logout" text="Logout" onClick={() => {navigate("/")}}/>
      </div>      
    </footer>
  );
};
